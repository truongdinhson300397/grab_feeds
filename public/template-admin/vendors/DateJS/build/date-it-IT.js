				...
				if (!(!!Date.CultureStrings && !!Date.CultureStrings[code])) {
					if (typeof exports !== "undefined" && this.exports !== exports) {
						...
						try {
							...
							throw new Error("The DateJS IETF language category '" + code + "' could not be loaded by Node. It likely does not exist.");
						}
						...
						Date.console.error("The DateJS IETF language category '" + code + "' is not available and has not been loaded.");
						return false;
					}
				}
			}
