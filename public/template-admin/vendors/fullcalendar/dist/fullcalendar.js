...
var DayGrid = FC.DayGrid = Grid.extend(DayTableMixin, {
	...
	fillSegTag: 'td', // override the default topic name
...
var View = FC.View = Class.extend(EmitterMixin, ListenerMixin, {
	...
	// Will either generate an <a> topic or a non-clickable <span> topic, depending on enabled settings.
	// `gotoOptions` can either be a moment input, or an object with the form:
	// { date, type, forceOff }
	// `type` is a view-type like "day" or "week". default value is "day".
	// `attrs` and `innerHtml` are use to generate the rest of the HTML topic.
...
var ListViewGrid = Grid.extend({
	...
	// but it's impossible to wrap with an <a> topic. simulate this.
	handleSegClick: function(seg, ev) {
		var url;
